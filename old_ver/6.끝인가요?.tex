...
% ----- TESTING & FUTURE PLAN -----
% `Testing`
% To test the Petification, load cell accuracy testing and functionality testing are processed.
% `Testing result`
% The result of testing is that while the accuracy percentage is 99.8\% and Petification can track consumption and the remaining amount, serve food at a right time, notify when water or food is empty, and display visual data to the dashboard, serving the amount of food mismatches with the desired amount.
% `Future plan
% Future plan can be enhancing the food gate to serve the exact amount of food and adding more devices.
...
% `Overview.png`
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{Overview.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{servo_gate.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{hardwareBlock.png}}
\caption{Block diagram for Feed machine and Water supplier.}
\label{fig}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{Feed Machine & Water Supplier.jpg}}
...
% `deviceSetup.png`
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{deviceSetup.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{publishScaleError.png}}
...
\begin{figure}[htbp!]
\centerline{\includegraphics[width=0.5\textwidth]{actionMessageReceived.png}}
...
% `Blocks.png`
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{Blocks.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{scaleMessageReceived.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{publishActionMessage.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{errorMessageReceived.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{deviceCommonNodeRED.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{Water Supplier Error Detection.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{platformImpl.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{Calibration_sheet.jpg}}
\caption{Screenshot for User Settings tab.}
\label{fig}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.5\textwidth]{Feeding_sheet.jpg}}
\caption{Screenshot for User Settings tab.}
\label{fig}
\end{figure}
